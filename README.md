...
## Что это?
Android-приложение, которое запускает LLM **полностью на устройстве**: без интернета, без облака, без слежки. Работает через Google MediaPipe LLM Inference API.
